% this skeleton code comes from Andrew Ng's autoencoder exercise, see
% http://ufldl.stanford.edu/wiki/index.php/Exercise:Sparse_Autoencoder
% We also used http://eric-yuan.me/ufldl-sa/ as a reference; implementing
% this was extremely hard (I spent many hours trying to do it just right),
% so this reference was very helpful. 
...
% first do a forward pass of the data
a1 = data;
a2 = bsxfun(@plus, W1 * a1, b1); % use bsxfun to add bias term to each column 
a2 = sigmoid(a2);
a3 = bsxfun(@plus, W2 * a2, b2);
a3 = sigmoid(a3);

% calculate the regular cost function J
errtp = ((a3 - data) .^ 2) ./ 2; 
...
% now calculate the gradients of the weights
